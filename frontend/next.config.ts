...
const nextConfig: NextConfig = {
  ...
  // templates) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â pin Turbopack's root to this app so it doesn't guess wrong.
  turbopack: {
    root: __dirname,
  },
  ...
  /* Telegram Mini App'ni lokal serverda sinash uchun sahifa cloudflared tunnel
     ...
     kelgan ichki so'rovlarni (HMR, _next/*) sukut bo'yicha bloklaydi ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â
     tunnel manzili shu ro'yxatga qo'shilishi kerak. Tunnel manzili
     o'zgarganda bu qatorni ham yangilang. */
  allowedDevOrigins: ['winter-hwy-wash-utilities.trycloudflare.com'],

  /* Django API va media SHU origin ostidan uzatiladi.
     Nega: Telegram Mini App telefonda ochiladi ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â u yerdan `localhost:8001` ga chiqib
     ...
     kodga yoziladi). Bitta origin bo'lsa ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â qayta yig'ish ham, CORS ham kerak emas.
     ...
     yo'naltiradi. Destination'da slash ochiq yozilgan ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â aks holda Next slashni olib
